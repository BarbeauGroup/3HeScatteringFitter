...
if "208" in sys.argv[1]:
  ...
  if not "Krasz" in sys.argv[1]:
    ...
    iasAmp=ROOT.RooRealVar("iasAmp","iasAmp",500,50,800)
  else:
  ...
  sdrAmp=ROOT.RooRealVar("sdrAmp","sdrAmp",100,100,2000)
  sdrGauss=ROOT.RooGaussian("sdrGauss","sdrGauss",eVar,sdrMean,sdrSigma)
  
  gtr1Mean=ROOT.RooRealVar("gtr1Mean","GTR1",8,7.5,8.5)
  ...
  gtr2Amp=ROOT.RooRealVar("gtr2Amp","gtr2Amp",20,10,2000)
  gtr2Gauss=ROOT.RooGaussian("gtr2Gauss","gtr2Gauss",eVar,gtr2Mean,gtr2Sigma)
  
  if not "Krasz" in sys.argv[1]:
    n12Mean=ROOT.RooRealVar("n12Mean","12N (bgnd)",15.5,15.4,15.7)
    n12Sigma=ROOT.RooRealVar("n12Sigma","n12Sigma",0.18,0.10,0.19)
  ...
  g7Amp=ROOT.RooRealVar("g7Amp","g7Amp",10,1,500)
  ...
  qfcAmp=ROOT.RooRealVar("qfcAmp","qfcAmp",40000,35000,80000)
  
  iasMean=ROOT.RooRealVar("iasMean","IAS",17.5,17,18)
  iasSigma=ROOT.RooRealVar("iasSigma","iasSigma",0.18,0.15,0.20)
  iasAmp=ROOT.RooRealVar("iasAmp","iasAmp",1500,1000,2000)
  iasGauss=ROOT.RooGaussian("iasGauss","iasGauss",eVar,iasMean,iasSigma)

  gtrMean=ROOT.RooRealVar("gtrMean","GTR",17,16.5,18.5)
  gtrSigma=ROOT.RooRealVar("gtrSigma","gtrSigma",2.0,2.0,3)
  gtrAmp=ROOT.RooRealVar("gtrAmp","gtrAmp",35000,30000,50000)
  gtrGauss=ROOT.RooGaussian("gtrGauss","gtrGauss",eVar,gtrMean,gtrSigma)
  
  gtr1Mean=ROOT.RooRealVar("gtr1Mean","GTR1",6,3,8.5)
  gtr1Sigma=ROOT.RooRealVar("gtr1Sigma","gtr1Sigma",1.0,1.0,5.5)
  gtr1Amp=ROOT.RooRealVar("gtr1Amp","gtr1Amp",5000,4000,10000)
  gtr1Gauss=ROOT.RooGaussian("gtr1Gauss","gtr1Gauss",eVar,gtr1Mean,gtr1Sigma)
  
  gtr2Mean=ROOT.RooRealVar("gtr2Mean","GTR2",9.5,9.0,10)
  gtr2Sigma=ROOT.RooRealVar("gtr2Sigma","gtr2Sigma",2.0,1.5,4.0)
  gtr2Amp=ROOT.RooRealVar("gtr2Amp","gtr2Amp",3000,2000,9000)
  gtr2Gauss=ROOT.RooGaussian("gtr2Gauss","gtr2Gauss",eVar,gtr2Mean,gtr2Sigma)
  
  sdrMean=ROOT.RooRealVar("sdrMean","SDR",24,24,25)
  sdrSigma=ROOT.RooRealVar("sdrSigma","sdrSigma",3.5,3.0,4)
  sdrAmp=ROOT.RooRealVar("sdrAmp","sdrAmp",50000,50000,75000)
  sdrGauss=ROOT.RooGaussian("sdrGauss","sdrGauss",eVar,sdrMean,sdrSigma)
  ...
  n12Mean=ROOT.RooRealVar("n12Mean","12N (bgnd)",15.5,15.4,15.7)
  n12Sigma=ROOT.RooRealVar("n12Sigma","n12Sigma",0.18,0.10,0.19)
  n12Amp=ROOT.RooRealVar("n12Amp","n12Amp",20,20,1000)
  n12Gauss=ROOT.RooGaussian("n12Gauss","n12Gauss",eVar,n12Mean,n12Sigma)
  
  n12Mean2=ROOT.RooRealVar("n12Mean2","12N (bgnd)",16.75,16.4,17.)
  n12Sigma2=ROOT.RooRealVar("n12Sigma2","n12Sigma2",0.18,0.10,0.19)
  n12Amp2=ROOT.RooRealVar("n12Amp2","n12Amp2",20,20,1000)
  ...
  f16Sigma=ROOT.RooRealVar("f16Sigma","f16Sigma",0.18,0.10,0.19)
  f16Amp=ROOT.RooRealVar("f16Amp","f16Amp",20,20,1000)
  ...
  f16Amp2=ROOT.RooRealVar("f16Amp2","f16Amp2",20,20,1000)
  ...
  f16Sigma3=ROOT.RooRealVar("f16Sigma3","f16Sigma3",0.18,0.10,0.19)
  f16Amp3=ROOT.RooRealVar("f16Amp3","f16Amp3",20,20,1000)
  f16Gauss3=ROOT.RooGaussian("f16Gauss3","f16Gauss3",eVar,f16Mean3,f16Sigma3)
  
  pdfList=ROOT.RooArgList(qfc,iasGauss,gtrGauss,gtr1Gauss,gtr2Gauss,sdrGauss)
  backgroundPdfList=ROOT.RooArgList(n12Gauss,n12Gauss2,f16Gauss,f16Gauss2,f16Gauss3)
  pdfList.add(backgroundPdfList)
  
  ampList=ROOT.RooArgList(qfcAmp,iasAmp,gtrAmp,gtr1Amp,gtr2Amp,sdrAmp)
...
frame=eVar.frame()
dataHist.plotOn(frame,ROOT.RooFit.LineColor(ROOT.kBlack),ROOT.RooFit.Binning(100))
model.plotOn(frame)
...
if "208" in sys.argv[1]:
  ...
  #GT11_amp = ROOT.RooRealVar("GT11_amp","GT11_amp",sdrAmp.getVal()*scaleFactor)
  #GT12_amp = ROOT.RooRealVar("GT12_amp","GT12_amp",qfcAmp.getVal()*scaleFactor)
  sum=GT1_amp.getVal()+GT2_amp.getVal()+GT3_amp.getVal()+GT4_amp.getVal()+GT5_amp.getVal()+GT6_amp.getVal()+GT7_amp.getVal()+GT8_amp.getVal()+GT9_amp.getVal()+GT10_amp.getVal()#+GT12_amp.getVal()
  ...
  normalizedPdfList=ROOT.RooArgList(gtr1Gauss,gtr2Gauss,gtrGauss)#,qfc)
  ...
  normalizedAmpList=ROOT.RooArgList(GT8_amp,GT9_amp,GT10_amp)#,GT12_amp)
  ...
  GT10_amp = ROOT.RooRealVar("GT10_amp","GT10_amp",gtrAmp.getVal()*scaleFactor)
  GT12_amp = ROOT.RooRealVar("GT12_amp","GT12_amp",qfcAmp.getVal()*scaleFactor)
  sum=GT10_amp.getVal()+GT12_amp.getVal()
  print("Total GT strength: "+str(sum))

  #normalizedGaussPdfList=ROOT.RooArgList(g1Gauss,g2Gauss,g3Gauss,g4Gauss,g5Gauss,g6Gauss,g7Gauss)
  normalizedPdfList=ROOT.RooArgList(gtrGauss)
  #normalizedPdfList.add(normalizedGaussPdfList)

  #normalizedGaussAmpList=ROOT.RooArgList(GT1_amp,GT2_amp,GT3_amp,GT4_amp,GT5_amp,GT6_amp,GT7_amp)
  normalizedAmpList=ROOT.RooArgList(GT10_amp)
  #normalizedAmpList.add(normalizedGaussAmpList)
